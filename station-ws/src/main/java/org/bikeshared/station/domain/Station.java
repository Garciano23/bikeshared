package org.bikeshared.station.domain;

import java.util.concurrent.atomic.AtomicInteger;

import org.bikeshared.station.domain.exception.BadInitException;
import org.bikeshared.station.domain.exception.NoBikeSharedAvailException;
import org.bikeshared.station.domain.exception.NoBikeSharedAvailException;
import org.bikeshared.station.domain.exception.NoSlotAvailException;
...
public class Station {
	...
	public synchronized int returnBikeShared() throws NoSlotAvailException {
		if(getFreeDocks() == 0)
	...
	public synchronized void getBikeShared() throws NoBikeSharedAvailException {
		if(getFreeDocks() == getMaxCapacity())
			throw new NoBikeSharedAvailException();
    ...
    public synchronized int getAvailableBikeShared() {
